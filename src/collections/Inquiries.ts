...
export const Inquiries: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'arrival', type: 'date', label: { de: 'Anreise / Seminarbeginn', en: 'Arrival / seminar start' }, required: true, admin: { date: { pickerAppearance: 'dayOnly' } } },
    { name: 'departure', type: 'date', label: { de: 'Abreise / Seminarende', en: 'Departure / seminar end' }, admin: { date: { pickerAppearance: 'dayOnly' } } },
